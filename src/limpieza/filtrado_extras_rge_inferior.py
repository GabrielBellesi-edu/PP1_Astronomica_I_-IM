...
def procesar_y_consolidar_rge(
    ...
    ruta_salida="data/processed/2024_consolidado_extra_rge_inferior.csv",
    ...
    Args:
        ...
        rge_min (int): Valor mínimo de RGE para el filtro (por defecto -100)
        rge_max (int): Valor máximo de RGE para el filtro (por defecto 100)
    """
